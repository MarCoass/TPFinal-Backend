...
class TareaController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $tarea->save();
        return response()->json(['exito' => true, 'message' => 'Tarea creada correctamete', 200]);
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        $tarea->fecha_vencimiento = Carbon::parse($request->input('fecha_vencimiento'));
        $tarea->save();
        return response()->json(['exito' => true, 'message' => 'Tarea modificada correctamete', 200]);
    }
    ...
    public function cambiarEstado($id)
    {
        ...
        $tarea->estado = 1;
        $tarea->save();
        return response()->json(['exito' => true, 'message' => 'Estado modificado correctamete', 200]);
    }
